...
public class DirectorOfTeachingAndResearch extends Person implements SolveProblem, TrainEnterpriseEmployees, EditBook {
    public DirectorOfTeachingAndResearch() {
    }

    public DirectorOfTeachingAndResearch(String name, int age, int salary) {
        this.name = name;
        this.age = (byte) age;
        this.salary = salary;
    }
